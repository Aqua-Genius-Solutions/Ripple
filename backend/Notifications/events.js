...
const sendEventNotification = (event) => {
  ...
  const fcmOptions = {
    ...
    headers: {
      ...
      Authorization:
        "Bearer AAAAqB-JCts:APA91bF1jkeU3ZKgmQIpPe0SYAsFAD579RwlmNIPCGcz4V1nUtUyENV4VehsLaBxkuvardp_VI_KLiV1aPmvCoYRxG9xy3pM8lZtJOqu2ToHb3LEa0zZF_sG6xNAb2V6bhqY69ZoaOlN",
    },
  };
